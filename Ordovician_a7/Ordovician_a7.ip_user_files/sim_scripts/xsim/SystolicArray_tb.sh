...
#
# Script generated by Vivado on Sun May 11 16:42:59 +0800 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot SystolicArray_tb xil_defaultlib.SystolicArray_tb xil_defaultlib.glbl -log elaborate.log
}
