...
#
# Script generated by Vivado on Tue May 13 20:09:00 +0800 2025
...
#
# Usage        : read_tb.sh
#                read_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                read_tb.sh [-reset_run]
#                read_tb.sh [-reset_log]
#                read_tb.sh [-help]
#
...
# script info
echo -e "read_tb.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./read_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L blk_mem_gen_v8_4_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot read_tb xil_defaultlib.read_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim read_tb -key {Behavioral:sim_1:Functional:read_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb read_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./read_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: read_tb.sh [-help]\n\
Usage: read_tb.sh [-step]\n\
Usage: read_tb.sh [-lib_map_path]\n\
Usage: read_tb.sh [-reset_run]\n\
Usage: read_tb.sh [-reset_log]\n\
Usage: read_tb.sh [-keep_index]\n\
Usage: read_tb.sh [-noclean_files]\n\n\
