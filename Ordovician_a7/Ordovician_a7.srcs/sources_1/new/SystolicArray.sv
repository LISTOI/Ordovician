...
module SystolicArray (
    ...
    input  logic [31:0] Matrix_A        [0: 7][0:22], // 输入矩阵A，已填充气泡
    input  logic [31:0] Matrix_B        [0:22][0: 7], // 输入矩阵B，已填充气泡
    ...
    localparam integer K   = 23; // 含气泡后乘加深度

    logic [31:0] A_wire [0:ROW-1][0:COL]; // A方向流动线
    logic [31:0] B_wire [0:ROW][0:COL-1]; // B方向流动线
    ...
    always_comb begin
        ...
        case (state)
            ...
            CALC:  if (step_cnt == K + ROW + 3 ) next_state = DONE;
