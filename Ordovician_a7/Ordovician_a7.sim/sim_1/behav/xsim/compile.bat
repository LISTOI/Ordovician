...
REM
REM Generated by Vivado on Tue May 13 20:09:03 +0800 2025
...
echo "xvlog --incr --relax -L uvm -prj read_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj read_tb_vlog.prj -log xvlog.log
