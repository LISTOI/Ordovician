...
#
# Script generated by Vivado on Mon May 12 15:07:06 +0800 2025
# SW Build 6060944 on Thu Mar 06 19:10:01 MST 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : SystolicArray_tb.sh
...
#
# Usage        : SystolicArray_tb.sh
#                SystolicArray_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                SystolicArray_tb.sh [-reset_run]
#                SystolicArray_tb.sh [-reset_log]
#                SystolicArray_tb.sh [-help]
#
...
# script info
echo -e "SystolicArray_tb.sh - Script generated by export_simulation (Vivado v2024.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./SystolicArray_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot SystolicArray_tb xil_defaultlib.SystolicArray_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim SystolicArray_tb -key {Behavioral:sim_1:Functional:SystolicArray_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb SystolicArray_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./SystolicArray_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: SystolicArray_tb.sh [-help]\n\
Usage: SystolicArray_tb.sh [-step]\n\
Usage: SystolicArray_tb.sh [-lib_map_path]\n\
Usage: SystolicArray_tb.sh [-reset_run]\n\
Usage: SystolicArray_tb.sh [-reset_log]\n\
Usage: SystolicArray_tb.sh [-keep_index]\n\
Usage: SystolicArray_tb.sh [-noclean_files]\n\n\
